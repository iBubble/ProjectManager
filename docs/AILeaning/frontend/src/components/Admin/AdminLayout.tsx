...
import { Users, FolderKanban, ScrollText, Settings, ArrowLeft, ShieldCheck, ActivitySquare, Activity, Sparkles, TrendingUp } from 'lucide-react';
...
const navItems = [
  ...
  { path: '/admin/ragas', label: 'Ragas质量看板', icon: TrendingUp },
  { path: '/admin/audit', label: '合规审查审批', icon: ShieldCheck },
    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <main className="flex-1 p-8 overflow-auto">
        <Routes>
          ...
          <Route path="audit" element={<AuditApproval />} />
